  ...
  return (
    <>
      <div className={styles.home}>
        <h2 className={styles.pageTitle}>The Drink Route</h2>
        <p className={styles.pageInfo}>Find Your Next Favorite Drink</p>
        <p>Discover hundreds of recipes, from timeless classics to refreshing alcohol-free treats.</p>
      </div>
      <div className={styles.navcards}>
        <NavLink className={styles.navitem} to="/categories">
          <img src={categoryImg} alt="Category" height="200px" width="auto" />
          <h2 className={styles.title}>Categories</h2>
          <p className={styles.info}>Explore All Drink Categories</p>
        </NavLink>
        <NavLink className={styles.nonAlco} to="/nonalcoholic">
          <img src={nonalcoholicImg} alt="nonalcoholic" />
